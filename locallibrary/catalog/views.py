...
@permission_required('catalog.can_mark_returned')
def all_borrowed_books_view(request):
    book_instances = BookInstance.objects.filter(status__exact='o').order_by('due_back')
    return render(request, 'catalog/all_borrowed_books.html', {'bookinstance_list': book_instances})
